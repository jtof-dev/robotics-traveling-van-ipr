...
- [ ] figure out how to flash code to [the generic pi pico](https://a.co/d/8O0cdaL)
  - [ ] make template files (cmake like Kyle had for robot 2?)
...
- we need to decide if we need to use
